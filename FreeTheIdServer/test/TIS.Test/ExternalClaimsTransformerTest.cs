...
namespace Aguacongas.FreeTheIdServer.Test
{
    public class ExternalClaimsTransformerTest
    {
        ...
        public async Task TransformPrincipal_should_add_remove_claims()
        {
            ...
            var applicationDbContext = scope.ServiceProvider.GetRequiredService<ApplicationDbContext>();
            Assert.NotNull(await applicationDbContext.UserClaims.FirstOrDefaultAsync(c => c.ClaimType == "new"));
            Assert.Null(await applicationDbContext.UserClaims.FirstOrDefaultAsync(c => c.ClaimType == "test"));
        }
        ...
        private static IServiceCollection CreateServices()
        {
            ...
            var services = new ServiceCollection()
                ...
                .AddTransient<IdentityServerOptions>()
